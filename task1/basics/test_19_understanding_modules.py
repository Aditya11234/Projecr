...
- modules are used to reuse code located in other files
- modules respect scope rules
- modules need to be imported for using their functions, just like include keyword in c/c++
"""
