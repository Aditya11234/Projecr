...
def test_function_call_with_keyword_arguments():
    ...
    assert 'NameError: name first is not defined'== demo(second=20)
    assert 'NameError: name first is not defined' == demo(second=20, third=30)
    assert [10,2,30] == demo(first=10, third=30)
    assert [10,20,30] == demo(10, third=30)
